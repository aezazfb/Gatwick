...
class AddViasState extends State<AddVias> {
  ...
  String listTitle = '';
  bool gQbtn = true;
  ScrollController dirControl = ScrollController();
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBarTextField(
          ...
          searchButtonIcon: Icon(Icons.add_location_alt_outlined, size: 30),
          onChanged: (value) {
            setState(() {
              gQbtn = false;
              flage = false;
          ...
          onBackPressed: () {
            setState(() {
              if (mapState.destinationController.text.isNotEmpty &&
                  mapState.sourceController.text.isNotEmpty) {
                gQbtn = true;
                viasState.viasSuggestionList.clear();
                gQbtn = true;
                viasState.viasSuggestionList.clear();
                  ...
                  child: TextField(
                    onChanged: (bool) {
                      ...
                      if (mapState.sourceController.text.isNotEmpty &&
                          mapState.destinationController.text.isNotEmpty)
                        gQbtn = true;
                    },
                    cursorColor: Colors.black,
                              ...
                              onPressed: () {
                                setState(() {
                                  Marker markers = mapState.marker.firstWhere(
                                      (p) =>
                                          p.markerId ==
                                          MarkerId(viasState.viasList[index]),
                                      orElse: () => null);
                                  mapState.marker.remove(markers);
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  if (viasState.viasList.length < 7) {
                                    ...
                                    Toast.show(
                                        'You can not add more than 7 vias ',
                                        context,
                  ...
                  child: Visibility(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        ...
                        for (int i = 0;
                            i < viasState.viasLatLongList.length;
                            i++) {
                          mapState.addMarker(viasState.viasLatLongList[i],
                              "${viasState.viasList[i]}", 7, 90); //Via$i
                        }
